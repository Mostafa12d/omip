...
MatrixWrapper::Matrix NonLinearPrismaticMeasurementPdf::dfGet(unsigned int i) const
{
    ...
    {
        OMIP_ERROR_STREAM_NAMED("NonLinearPrismaticMeasurementPdf::dfGet",
                               "The derivative is not implemented for the " << i << "th conditional argument");
        throw std::runtime_error("NonLinearPrismaticMeasurementPdf::dfGet: derivative not implemented for this conditional argument");
    }
}
