...
MatrixWrapper::ColumnVector NonLinearRevoluteMeasurementPdf::ExpectedValueGet() const
{
    ...
    Twistd joint_pose = Twistd(rv * rev_joint_orientation.x(),
...
MatrixWrapper::Matrix NonLinearRevoluteMeasurementPdf::dfGet(unsigned int i) const
{
    ...
    {
        OMIP_ERROR_STREAM_NAMED( "NonLinearRevoluteMeasurementPdf::dfGet",
                    "The derivative is not implemented for the " << i << "th conditional argument");
        throw std::runtime_error("NonLinearRevoluteMeasurementPdf::dfGet: derivative not implemented for this conditional argument");
    }
}
