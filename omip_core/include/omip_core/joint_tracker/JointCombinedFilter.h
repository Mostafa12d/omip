...
#ifndef OMIP_CORE_JOINT_TRACKER_JOINTCOMBINEDFILTER_H_
#define OMIP_CORE_JOINT_TRACKER_JOINTCOMBINEDFILTER_H_
...
public:
   ...
   * reference rigid body and the internal state (joint parameters and latent variable)
   */
  std::map<JointFilterType, Twistd> getPredictedMeasurement();
  ...
  virtual void setInitialMeasurement(const joint_measurement_t &initial_measurement,
                                          const Twistd& rrb_pose_at_srb_birth_in_sf, const Twistd& srb_pose_at_srb_birth_in_sf);
...
#endif /* OMIP_CORE_JOINT_TRACKER_JOINTCOMBINEDFILTER_H_ */
