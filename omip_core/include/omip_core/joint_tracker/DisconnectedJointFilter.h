...
#ifndef OMIP_CORE_JOINT_TRACKER_DISCONNECTEDJOINTFILTER_H_
#define OMIP_CORE_JOINT_TRACKER_DISCONNECTEDJOINTFILTER_H_
...
#endif /* OMIP_CORE_JOINT_TRACKER_DISCONNECTEDJOINTFILTER_H_ */
