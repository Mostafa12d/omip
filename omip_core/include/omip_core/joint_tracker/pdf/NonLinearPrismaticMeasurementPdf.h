...
#ifndef OMIP_CORE_JOINT_TRACKER_PDF_NONLINEARPRISMATICMEASUREMENTPDF_H_
#define OMIP_CORE_JOINT_TRACKER_PDF_NONLINEARPRISMATICMEASUREMENTPDF_H_
...
namespace BFL
{
class NonLinearPrismaticMeasurementPdf : public AnalyticConditionalGaussianAdditiveNoise
{
public:
...
#endif /* OMIP_CORE_JOINT_TRACKER_PDF_NONLINEARPRISMATICMEASUREMENTPDF_H_ */
