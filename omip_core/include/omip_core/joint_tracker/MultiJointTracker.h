...
#ifndef OMIP_CORE_JOINT_TRACKER_MULTIJOINTTRACKER_H_
#define OMIP_CORE_JOINT_TRACKER_MULTIJOINTTRACKER_H_

#include <list>

#include <boost/shared_ptr.hpp>

#include "omip_core/joint_tracker/JointCombinedFilter.h"
...
protected:
  ...
  std::map<std::pair<int, int>, Twistd > _rrb_pose_at_srb_birthday_in_sf;

  // Save the pose of the SRB in the SF when the SRB was born
  std::map<std::pair<int, int>, Twistd > _srb_pose_at_srb_birthday_in_sf;

  boost::shared_ptr<ks_measurement_t> _last_rcvd_poses_and_vels;


  boost::shared_ptr<ks_measurement_t> _previous_rcvd_poses_and_vels;
  ...
  std::list<boost::shared_ptr<ks_measurement_t> > _n_previous_rcvd_poses_and_vels;
...
#endif /* OMIP_CORE_JOINT_TRACKER_MULTIJOINTTRACKER_H_ */
